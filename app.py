...
def display_assessment():
    ...
    st.markdown("<h4 style='font-family: \"DejaVu Sans\"; margin: -30px 0 0 0;'>Of the following vital signs within the intake form, check the vital signs that are abnormal.</h4>", unsafe_allow_html=True)
