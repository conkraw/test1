...
from utils.firebase_operations import initialize_firebase, upload_to_firebase, FIREBASE_COLLECTION_NAME
...
def main():
    ...
    if "document_id" not in st.session_state:
        ...
        existing_data = db.collection(FIREBASE_COLLECTION_NAME).document(st.session_state.document_id).get()
        if existing_data.exists:
            st.session_state.update(existing_data.to_dict())
